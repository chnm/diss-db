...
urlpatterns = [
    ...
    path("api/school-network/<int:school_id>/", views.get_school_network_data, name="school-network-data"),
    path("api/departments/", views.department_list_api, name="department-list-api"),
    path("api/departments/create/", views.department_create_api, name="department-create-api"),
